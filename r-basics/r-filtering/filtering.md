Instead of `[]` parenthesis, one could use dedicated functions: `Filter` and `subset`. They may not seem much at the moment but they bring value once working with data frames instead of simple vectors and lists.
